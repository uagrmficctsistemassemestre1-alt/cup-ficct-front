...
function Content() {
  ...
  const path = convId ? `/convocatorias/${convId}/asignacion-carreras` : "";
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Cupos, asignados y disponibles por carrera en una convocatoria."
      />
      ...
      <div className="mb-3 flex justify-end">
        <ExportButtons
          disabled={!data}
          onExport={(format) => exportar(params(), format, "asignacion-carreras")}
        />
      </div>
...
export default function AsignacionCarrerasPage() {
  return (
